...
- Menyebut grade / kriteria / tingkat kekritisan → **seberang** `60-mutu-dan-tindak-lanjut.md`.
- Menyebut status alur (draft/verifikasi/selesai) → **seberang** `31-status-dan-alur.md`.
