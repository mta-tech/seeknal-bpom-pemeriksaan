...
PENTING: **"Nilai sarana" bukan `grade`.** Aturan penilaian unit menyebut "nilai sarana A/B/C/D" sebagai
...
- Menyebut vonis MK/TMK: buka `30-kesimpulan.md`.
- Menyebut temuan produk: buka `40-temuan-produk.md`.
- Mempertanyakan keterisian kolom: buka `90-kualitas-data.md`.

---

<!-- MANIFES
tabel: mv_kriteria_pemeriksaan, mv_pemeriksaan
kolom: grade, hp_followup_name, kesimpulan, nama_sarana, tingkat_pemenuhan_cpob, tl_saran_names, tx_criteria, tx_criteria_desc, tx_critical_issue, tx_major_issue, tx_minor_issue
nilai: -
-->
