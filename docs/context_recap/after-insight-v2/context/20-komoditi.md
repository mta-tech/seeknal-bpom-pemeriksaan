...
## Ejaan berbeda dari domain lain
...
- Menyentuh target atau capaian: buka `85-target-capaian.md`.
- Menyebut MD / IRT / jenis pangan: buka `50-jenis-pangan.md`.
- Menyebut rantai sarana: buka `10-sarana-dan-fasilitas.md`.

---

<!-- MANIFES
tabel: mv_pemeriksaan_petugas, target_balai
kolom: jenis_sarana, komoditi, mapping_komoditi_target_balai
nilai: BAHAN BERBAHAYA, KOSMETIK, KOSMETIKA, OBAT, OBAT KUASI, OBAT TRADISIONAL, OBAT TRADISIONAL (OT), PRODUK PANGAN
-->
