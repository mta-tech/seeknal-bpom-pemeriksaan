...
## Kolom `komoditi` di tabel ini berbeda artinya
...
- Menyebut alur persetujuan: buka `31-status-dan-alur.md`.
- Menyebut balai/UPT: buka `10-sarana-dan-fasilitas.md`.

---

<!-- MANIFES
tabel: mv_pemeriksaan_petugas
kolom: daftar_balai_pemeriksa, id_pemeriksaan, jenis_id, jenis_sarana, klasifikasi, komoditi, nomorsurat, petugas, petugas_id, tgl_surat, tujuan
nilai: -
-->
