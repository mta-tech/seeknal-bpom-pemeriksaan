...
## Kolom ini adalah FILTER TERSEMBUNYI
...
- Kembali ke konsep sarana: buka `10-sarana-dan-fasilitas.md`.
- Menyentuh temuan atau nilainya: buka `40-temuan-produk.md`.
- Mempertanyakan arti kekosongan kolom: buka `90-kualitas-data.md`.

---

<!-- MANIFES
tabel: -
kolom: klasifikasi_distribusi, klasifikasi_sarana, komoditi, sarana
nilai: -
-->
